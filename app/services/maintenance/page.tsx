...
export const metadata: Metadata = {
  ...
  description:
    'Professional aquarium maintenance plans starting at $149/month. Weekly or bi-weekly service visits, water changes, parameter testing, and priority emergency support. Serving all of Palm Beach County.',
...
const DEFAULT_TIERS = [
  ...
  },
  {
    ...
    price: 44900,
    billingCycle: 'month',
    tagline: 'White-glove, hands-off care',
    isPopular: false,
    stripePriceId: process.env.STRIPE_PRICE_PREMIER ?? '',
    callToAction: 'Start Premier',
    features: [
      'Weekly service visits',
