...
export const SERVICE_AREAS: ServiceAreaData[] = [
  ...
  },
  {
    ...
    intro: 'Palm Beach Gardens is home to some of the most impressive custom aquarium installations in South Florida. From sprawling estates in the Acreage to contemporary homes near PGA Boulevard, Aquaholics builds and maintains stunning reef and freshwater systems throughout the Gardens. Our team services hundreds of tanks across the Mirasol, BallenIsles, and Frenchman\'s Reserve communities.',
    ...
    testimonials: [
      { name: 'Robert A.', rating: 5, text: 'Aquaholics maintains three tanks in our BallenIsles home. Professional, reliable, and the fish are always thriving.', neighborhood: 'BallenIsles' },
  ...
  },
  {
    ...
    intro: 'Jupiter\'s coastal lifestyle is the perfect backdrop for world-class reef tanks. Aquaholics services everything from Jupiter Farms estates to waterfront condos along the Intracoastal. With Jupiter being just 20 minutes north of our WPB base, our team can reach any address in Jupiter within an hour — including 24/7 emergency callouts.',
  ...
  },
  {
    ...
    intro: 'Boca Raton\'s affluent communities demand the finest in custom aquarium design. Aquaholics Aquarium Services brings the same level of precision and artistry to Boca installations as we do throughout Palm Beach County. From glass-walled reef tanks in Boca Hills estates to sleek modern builds in Mizner Park condos, we build systems that become the centerpiece of any room.',
    ...
    testimonials: [
      { name: 'Michelle S.', rating: 5, text: 'Aquaholics designed a custom 300-gallon peninsula tank for our Boca West home. The craftsmanship is extraordinary.', neighborhood: 'Boca West' },
  ...
  },
  {
    ...
    testimonials: [
      { name: 'Priya K.', rating: 5, text: 'Our Atlantic Avenue restaurant has a custom coral reef display that draws comments from every table. Aquaholics nailed the design.', neighborhood: 'Downtown Delray' },
    ],
  },
  {
    slug: 'boynton-beach',
    ...
    intro: 'Boynton Beach has been one of our fastest-growing service areas. From Quantum Lakes condos to single-family homes in Hunters Run, we\'ve built and maintained hundreds of tanks throughout Boynton. Our clients love the combination of expert technical service and genuine passion for the hobby that every Aquaholics technician brings to each visit.',
  ...
  },
  {
    ...
    intro: 'Lake Worth Beach\'s eclectic, artistic community has always appreciated exceptional design — including aquarium design. Aquaholics\' installations in Lake Worth range from vibrant reef tanks in the historic cottage district to large commercial builds for local businesses. As a company based just miles away in West Palm Beach, Lake Worth is practically our backyard.',
    ...
    testimonials: [
      { name: 'Denise A.', rating: 5, text: 'Aquaholics is literally 10 minutes from my house and they\'re the best I\'ve ever worked with. Fast, knowledgeable, fair prices.', neighborhood: 'Downtown Lake Worth' },
    ],
  },
  {
    slug: 'wellington',
  ...
  },
  {
    ...
    testimonials: [
      { name: 'Thomas R.', rating: 5, text: 'My Singer Island condo looks like a luxury hotel thanks to the reef Aquaholics built. Guests always stop and stare.', neighborhood: 'Singer Island' },
    ],
  },
  {
    ...
    testimonials: [
      { name: 'Anne W.', rating: 5, text: 'I can\'t recommend Aquaholics enough. My reef tank is the pride of our Old Port Cove home and they keep it magazine-perfect.', neighborhood: 'Old Port Cove' },
    ],
  },
  {
    slug: 'juno-beach',
    ...
    testimonials: [
      { name: 'Sandy L.', rating: 5, text: 'Living right on the water, I wanted a reef tank that felt like it belonged here. Aquaholics created exactly that.', neighborhood: 'Juno Beach' },
    ],
  },
  {
    slug: 'palm-beach',
    ...
    testimonials: [
      { name: 'C. Worthington', rating: 5, text: 'Aquaholics operates with the discretion and professionalism the Palm Beach community requires. Their work is truly exceptional.', neighborhood: 'North End' },
    ],
  },
  {
    slug: 'tequesta',
