...
async function seedPricingTiers() {
  ...
  const tiers = [
    { _id: 'pricingTier-essential', name: 'Essential', price: 20000, billingCycle: 'month', tagline: 'Perfect for smaller systems', isPopular: false, order: 1, callToAction: 'Start Essential', stripePriceId: process.env.STRIPE_PRICE_ESSENTIAL ?? '', features: ['Twice-monthly (bi-weekly) service visits', 'Water change (up to 15%)', 'Parameter testing (8 parameters)', 'Glass & equipment cleaning', 'Monthly health report', 'Up to 75-gallon tank', 'Email support'] },
    { _id: 'pricingTier-professional', name: 'Professional', price: 60000, billingCycle: 'month', tagline: 'Our most popular plan', isPopular: true, order: 2, callToAction: 'Start Professional', stripePriceId: process.env.STRIPE_PRICE_PROFESSIONAL ?? '', features: ['Weekly service visits', 'Water change (up to 20%)', 'Full parameter testing (14 parameters)', 'Glass, sump & equipment cleaning', 'Livestock health assessment', 'Bi-weekly photo report', 'Up to 300-gallon tank', 'Priority phone support', '20% off emergency calls', '10% off livestock purchases'] },
    { _id: 'pricingTier-premier', name: 'Premier', price: 60000, billingCycle: 'month', tagline: 'Commercial & large-system care — from $600, scaling with tank size', isPopular: false, order: 3, callToAction: 'Request Premier Quote', stripePriceId: process.env.STRIPE_PRICE_PREMIER ?? '', features: ['Weekly service visits', 'Water change (up to 25%)', 'Complete parameter suite + ICP testing', 'Full system cleaning & maintenance', 'Coral & livestock fragging when needed', 'Weekly photo & video report', 'Tanks up to 1,000 gallons+ (larger by custom quote)', 'Dedicated technician', '24/7 dedicated phone line', 'Free emergency calls (parts only)', '15% off livestock purchases', 'Annual aquascape refresh included', 'Geared for commercial installations — scales to $1,000/mo'] },
  ]
...
async function seedFAQs() {
  ...
  const faqs = [
    ...
    { q: 'How much does aquarium maintenance cost?', a: 'Our Essential plan starts at $200/month (twice-monthly visits) for smaller systems. Most residential clients on our Professional plan pay $600/month for weekly service. Commercial and large-system Premier plans range from $600–$1,000/month depending on tank size, with custom pricing for installations above 1,000 gallons. Every plan includes water changes, parameter testing, glass cleaning, and equipment checks.', cat: 'Maintenance' },
    { q: 'Can I buy livestock from Aquaholic?', a: 'Aquaholic is not a retail store and does not ship. Nick keeps a small rotating holding system for service clients. Request a client account, and once approved you can see what corals, fish, and inverts are available for pickup in Riviera Beach or drop-off on your next service visit.', cat: 'Livestock' },
