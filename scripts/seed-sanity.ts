...
async function seedFAQs() {
  ...
  const faqs = [
    ...
    { q: 'Do you offer a DOA guarantee for livestock?', a: 'Yes — all livestock purchases are covered by our 48-hour DOA policy. If any animal arrives dead or perishes within 48 hours under normal acclimation conditions, we will issue a full credit toward a replacement.', cat: 'Livestock' },
    ...
    { q: 'Can you set up a tank in a rental property or condo?', a: 'Absolutely. We have extensive experience working in condos, apartments, and rental units. We use waterproofing mats, drip trays, and careful plumbing practices to meet HOA requirements. We can also provide documentation of our insurance for building management if required.', cat: 'Installation' },
